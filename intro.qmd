...
There are 100's of functions, it will take a while to learn which functions exist and what they do, but it is often pretty intuitive. Here are a few of the ones you are likley to use regularly:

`summary`, `length`, `head`, `str`, `min`, `max`, `median`, `mean`, `sd`, `abs`,
`as.numeric`, `as.integer`, `as.charactor`, `as.factor`, `cbind`, `rbind`, `c`,
