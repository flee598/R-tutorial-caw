...
I pretty much have Google open the whole time I am using `R`. Copy and paste error messages into Google. Most often the best answers will come from Stack Overflow.

Finding the right answer to your peobelm is a matter of learning the write jargon to Google.
