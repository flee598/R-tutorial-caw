...
Quick introduction to connecting RStudio to GitHub. The session will be broken down into two main components:
...
Once you have the above sorted associate your details with Git.
...
Set up credentials so we can access and alter GitHub repositories from `R`. Use the following code to take you to GitHub and generate a PAT.
